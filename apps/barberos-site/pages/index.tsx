...
const Home = () => (
  <BarLayout>
    ...
    <p>Notre équipe crée et vous accompagne dans vos projets de création de sites Web, sites vitrines, landing pages, CRM, ERP.</p>
    ...
    <section className="offer-line">
      ...
      <div>
        ...
        <p>
          Parce que chaque besoin est unique, nous vous accompagnons dans votre projet durant toutes les phases de sa conception. Nous vous
          apportons aussi notre expérience pour vous proposer la solution la plus adaptée possible. Nous pouvons intervenir à tout moment dans votre
        ...
        <p>
          Par ailleurs, nous vous accompagnons sur l’audit de vos applications existantes sur des sujets comme des problèmes de performances, de
    ...
    <section className="offer-line offer-line-even">
      ...
      <div>
        ...
        <p>
          Nous vous proposons des solutions opérationnelles pour vous et vos collaborateurs. D’une part ces solutions vous permettront
    ...
    <section className="offer-line">
      ...
      <div>
        ...
        <p>
          Nous participons à la montée en compétences de vos équipes de développeurs, sur des sujets techniques orientés Développeur ou
