...
export default function Page() {
  return (
    <>
      ...
      <p>
        This SERVICE is provided by Barberos (<a href="https://barberos.fr">https://barberos.fr</a>) at no cost and is
        ...
        <br />
        The terms used in this Privacy Policy have the same meanings as in our <Link href={ "terms-and-conditions" }>Terms
        and Conditions</Link>
        , which are accessible at Barberos unless otherwise defined in this Privacy Policy.
      </p>
      ...
      <p>
        ...
        including but not limited to Email Na, Activity data. The information that we request will be retained by us and
      ...
      <p>
        ...
        information (through
        third-party products) on your device called Log Data. This Log Data may include information such as your device
        Internet Protocol
      ...
      <p>
        ...
        that use “cookies” to
        collect information and improve their services. You have the option to either accept or refuse these cookies and
        know when a cookie is
        being sent to your device. If you choose to refuse our cookies, you may not be able to use some portions of this
        Service.
      </p>
      ...
      <p>
        ...
        it. But remember that no method of transmission over the internet, or method of electronic storage is 100%
        secure and reliable, and we
      ...
      <p>
        ...
        information from
        children under 13 years of age. In the case we discover that a child under 13 has provided us with personal
        information, we
